    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
        ...
        <nav>
            <ul style="list-style: none; display: flex; gap: 20px; margin: 0; padding: 0;">
                <li><a href="<c:url value = "/WEB-INF/view/index.jsp"/>" style="text-decoration: none; color: #007bff;">Main</a></li>
                <li><a href="<c:url value = "/WEB-INF/view/categories.jsp"/>" style="text-decoration: none; color: #007bff;">fdslkfdsklj</a></li>
